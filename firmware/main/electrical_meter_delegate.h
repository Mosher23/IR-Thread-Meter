...
private:
    // No power measurement is available until the first valid SML reading.
    // A synthetic zero would corrupt power history and derived statistics.
    NullableInt64 mActivePower{chip::app::DataModel::NullNullable};
};
